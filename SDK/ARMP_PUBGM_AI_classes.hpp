...
{
public:
	struct FScriptMulticastDelegate                    OnUnitTakeDamage;                                         // 0x0598(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      bEnableTeamAI : 1;                                        // 0x05A8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x7];                                       // 0x05A9(0x0007) MISSED OFFSET
	TArray<class UClass*>                              TeamAIClasses;                                            // 0x05B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                SpawnerTeamID;                                            // 0x05C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBotCategray>                          SpeciesCategory;                                          // 0x05C4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x05C5(0x0003) MISSED OFFSET
	int                                                SpawnerCampItemID;                                        // 0x05C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                GroupID;                                                  // 0x05CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UActorComponent*>                     TeamAIComponents;                                         // 0x05D0(0x0010) (ExportObject, ZeroConstructor)
...
public:
	...
	TMap<TEnumAsByte<EBotCategray>, int>               UnitsNumberThreshold;                                     // 0x0258(0x0050) (ZeroConstructor)
...
// 0x1280 (0x1458 - 0x01D8)
class UAIStateInfoComponentBase : public UAIBasicStateInfoComponent
{
public:
	struct FAIStateInfoBaseMod                         CacheAIStateInfoBaseMod;                                  // 0x01D8(0x03F8)
	struct FAIStateInfoBaseMod                         LastAIStateInfoBaseMod;                                   // 0x05D0(0x03F8)
	struct FDiffAIStateInfoBaseModGeneral              CacheDiffAIStateInfoBaseModGeneral;                       // 0x09C8(0x0588)
	struct FDiffAIStateInfoBaseMod                     CacheDiffAIStateInfoBaseMod;                              // 0x0F50(0x03F8)
	bool                                               IsTouchedPlayer;                                          // 0x1348(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x1349(0x0003) MISSED OFFSET
	uint32_t                                           FrameNo;                                                  // 0x134C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x1350(0x0008) (ZeroConstructor, IsPlainOldData)
	class AController*                                 OwnerController;                                          // 0x1358(0x0008) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x1360(0x0008) (ZeroConstructor, IsPlainOldData)
	class UAIActingComponent*                          AIActingComp;                                             // 0x1368(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class APawn*                                       MyOwnerPawn;                                              // 0x1370(0x0008) (ZeroConstructor, IsPlainOldData)
	class ABattleRoyaleGameModeBase*                   MyGameMode;                                               // 0x1378(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x40];                                      // 0x1380(0x0040) MISSED OFFSET
	TMap<int, class APickUpWrapperActor*>              CacheAINearbyItem;                                        // 0x13C0(0x0050) (ZeroConstructor)
	TArray<class ASTExtraBaseCharacter*>               CacheNearbyEnemies;                                       // 0x1410(0x0010) (ZeroConstructor)
	struct FCacheNearbyItemState                       CacheNearbyItemState;                                     // 0x1420(0x0020)
	class UMLAIControllerComponent*                    MyMLAIControllerComp;                                     // 0x1440(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	uint32_t                                           CacheModeMapId;                                           // 0x1448(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x144C(0x000C) MISSED OFFSET
...
// 0x0760 (0x1BB8 - 0x1458)
class UAIStateInfoComponentBRBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoBRBase                          CacheAIStateInfoBRBase;                                   // 0x1458(0x01C8)
	struct FAIStateInfoBRBase                          LastAIStateInfoBRBase;                                    // 0x1620(0x01C8)
	struct FDiffAIStateInfoBRBaseGeneral               CacheDiffAIStateInfoBRBaseGeneral;                        // 0x17E8(0x0248)
	struct FDiffAIStateInfoBRBase                      CacheDiffAIStateInfoBRBase;                               // 0x1A30(0x0188)
...
// 0x01C0 (0x1618 - 0x1458)
class UAIStateInfoComponentMPBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoMPBase                          CacheAIStateInfoMPBase;                                   // 0x1458(0x0090)
	struct FAIStateInfoMPBase                          LastAIStateInfoMPBase;                                    // 0x14E8(0x0090)
	struct FDiffAIStateInfoMPBaseGeneral               CacheDiffAIStateInfoMPBaseGeneral;                        // 0x1578(0x00A0)
...
// 0x00C0 (0x16D8 - 0x1618)
class UAIStateInfoComponentTeamDeath : public UAIStateInfoComponentMPBase
{
public:
	struct FAIStateInfoTeamDeath                       CacheAIStateInfoTeamDeath;                                // 0x1618(0x0040)
	struct FAIStateInfoTeamDeath                       LastAIStateInfoTeamDeath;                                 // 0x1658(0x0040)
	struct FDiffAIStateInfoTeamDeathGeneral            CacheDiffAIStateInfoTeamDeathGeneral;                     // 0x1698(0x0040)
...
public:
	...
	unsigned char                                      bFilterBuilding : 1;                                      // 0x00D4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFilterWater : 1;                                         // 0x00D4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bReachableTest : 1;                                       // 0x00D4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFilterOutBehaviorRegion : 1;                             // 0x00D4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bUseNavmesh : 1;                                          // 0x00D4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00D5(0x0003) MISSED OFFSET
	struct FName                                       SpecificNaVName;                                          // 0x00D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     CollisionChannel;                                         // 0x00E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00E1(0x0003) MISSED OFFSET
	float                                              MaxLocationTraceHeightZ;                                  // 0x00E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData08[0x5F];                                      // 0x02B9(0x005F) MISSED OFFSET
...
public:
	...
	bool                                               bNotiyParachuteComp;                                      // 0x0218(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData04[0x20];                                      // 0x04D0(0x0020) MISSED OFFSET
	TMap<uint32_t, int>                                CachePlayerRevivalTypes;                                  // 0x04F0(0x0050) (ZeroConstructor)
	class UMLAIStateInfoManager*                       MLAIStateInfoManager;                                     // 0x0540(0x0008) (ZeroConstructor, IsPlainOldData)
	int                                                AirDropTag;                                               // 0x0548(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0xC];                                       // 0x054C(0x000C) MISSED OFFSET
	TMap<class AActor*, class ASpecialZoneActor*>      CacheSpecialZoneParents;                                  // 0x0558(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x18];                                      // 0x05A8(0x0018) MISSED OFFSET
...
{
public:
	int                                                ZoneID;                                                   // 0x0430(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Radius;                                                   // 0x0434(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                Type;                                                     // 0x0438(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDynamic;                                                // 0x043C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x043D(0x0003) MISSED OFFSET
	int                                                CustomState;                                              // 0x0440(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class ASTExtraVehicleBase*                         ControlledVehicle;                                        // 0x07F0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FAIVehicleStateData                         AIVehicleStateData;                                       // 0x07F8(0x0080)
	class UAIBehaviorAdapter_VehicleBase*              AIBehaviorAdapter;                                        // 0x0878(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
