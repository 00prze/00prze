...
public:
	...
	int                                                iRegionActor;                                             // 0x04F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x04FC(0x0002) MISSED OFFSET
	bool                                               bStaticAddNetworkActor;                                   // 0x04FE(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      AutoDormancyType;                                         // 0x04FF(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class APlayerController*                           OwningController;                                         // 0x0438(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UDataTableRowDesc*                           Desc;                                                     // 0x00E8(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x1];                                       // 0x0F30(0x0001) MISSED OFFSET
	bool                                               bVisibleWithLOD;                                          // 0x0F31(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xE];                                       // 0x0F32(0x000E) MISSED OFFSET
