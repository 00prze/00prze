...
public:
	...
	unsigned char                                      UnknownData02[0x3E8];                                     // 0x00A8(0x03E8) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData06[0x910];                                     // 0x03C0(0x0910) MISSED OFFSET
	class USCoronaClientData*                          SecurityCoronaLabClientDataPointer;                       // 0x0CD0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x70];                                      // 0x0CD8(0x0070) MISSED OFFSET
	TArray<struct FString>                             MatchedApps;                                              // 0x0D48(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x18];                                      // 0x0D58(0x0018) MISSED OFFSET
	TArray<struct FString>                             ReceivedInstalledApp;                                     // 0x0D70(0x0010) (ZeroConstructor)
	struct FScriptMulticastDelegate                    OnServerReceiveInstalledAppDelegate;                      // 0x0D80(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData09[0x1C];                                      // 0x0D90(0x001C) MISSED OFFSET
	int                                                ReceivedRotationModifiedCount;                            // 0x0DAC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedTranslationModifiedCount;                         // 0x0DB0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                ReceivedScale3DModifiedCount;                             // 0x0DB4(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        LastInvalidIndexListInPakLite;                            // 0x0DB8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData10[0x8];                                       // 0x0DC8(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnServerReceiveInvalidFilesInPakLiteDelegate;             // 0x0DD0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData11[0xE8];                                      // 0x0DE0(0x00E8) MISSED OFFSET
	float                                              TouchScreenActiveTimeRatioThreshold;                      // 0x0EC8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0ECC(0x0004) MISSED OFFSET
	float                                              MouTa;                                                    // 0x0ED0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                BandaCountThreshold;                                      // 0x0ED4(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bEnableBandCount;                                         // 0x0ED8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x3];                                       // 0x0ED9(0x0003) MISSED OFFSET
	float                                              IntervalThreshold1;                                       // 0x0EDC(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HongThreshold;                                            // 0x0EE0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              NovoThreshold;                                            // 0x0EE4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x8];                                       // 0x0EE8(0x0008) MISSED OFFSET
