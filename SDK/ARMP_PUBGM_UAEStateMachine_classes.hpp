...
{
public:
	class UUAEStateMachineComponent*                   UAEStateMachineComponent;                                 // 0x0430(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
