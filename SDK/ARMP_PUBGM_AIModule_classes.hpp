...
public:
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x0520(0x0001) MISSED OFFSET
	bool                                               UseGameplayTasksComponent;                                // 0x0521(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShareNavigationSystem;                                   // 0x0522(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x0523(0x0001) MISSED OFFSET
	struct FVector                                     ShareNavSysOffset;                                        // 0x0524(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bEnableActiveRegion;                                      // 0x0530(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UEnvQuery*                                   QueryTemplate;                                            // 0x0870(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x0878(0x0010) (Edit, ZeroConstructor, EditConst)
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x0888(0x0010) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x0898(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x089C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x08A0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawLabels : 1;                                          // 0x08A1(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x08A1(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x08A1(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x08A1(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x08A1(0x0001) (Edit)
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x08A2(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2D];                                      // 0x08A3(0x002D) MISSED OFFSET
