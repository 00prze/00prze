...
struct FGameModePlayerParams
{
	...
	struct FGameModePlayerEquipmentAvatar              EquipmentAvatar;                                          // 0x0140(0x000C)
	unsigned char                                      UnknownData05[0x4];                                       // 0x014C(0x0004) MISSED OFFSET
	TArray<struct FGameModeWeaponDIYPlanData>          WeaponDIYPlanData;                                        // 0x0150(0x0010) (ZeroConstructor)
	int                                                VehicleSkinInReady;                                       // 0x0160(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0164(0x0004) MISSED OFFSET
	struct FGameModePlayerAliasInfo                    AliasInfo;                                                // 0x0168(0x0048)
	struct FGameModePlayerUpassInfo                    UpassInfo;                                                // 0x01B0(0x0038)
	struct FGameModePlayerPetInfo                      PetInfo;                                                  // 0x01E8(0x0020)
	TArray<struct FGameModePlayerPetInfo>              AdditionalPetInfo;                                        // 0x0208(0x0010) (ZeroConstructor)
	int                                                UsingAdditionalPetIndex;                                  // 0x0218(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x4];                                       // 0x021C(0x0004) MISSED OFFSET
	TArray<struct FGameModePlayerKnapsackExtInfo>      KnapsackExtInfoList;                                      // 0x0220(0x0010) (ZeroConstructor)
	TArray<struct FGameModePlayeWeaponSchemeInfo>      WeaponSchemeInfoList;                                     // 0x0230(0x0010) (ZeroConstructor)
	int                                                CurWeaponSchemeIndex;                                     // 0x0240(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PveLevel;                                                 // 0x0244(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<int>                                        CharSkillList;                                            // 0x0248(0x0010) (ZeroConstructor)
	struct FGameModePlayerBanChat                      banChat;                                                  // 0x0258(0x0018)
	struct FGameModePlayerBanChat                      banTarget;                                                // 0x0270(0x0018)
	TArray<struct FSpecialPickItem>                    SpecialPickItem;                                          // 0x0288(0x0010) (ZeroConstructor)
	struct FAchievementPrize                           EquippedAchievementPrize;                                 // 0x0298(0x000C)
	unsigned char                                      UnknownData08[0x4];                                       // 0x02A4(0x0004) MISSED OFFSET
	TArray<int>                                        audioChat;                                                // 0x02A8(0x0010) (ZeroConstructor)
	struct FName                                       CurrentPlayerState;                                       // 0x02B8(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       CurrentCharacterState;                                    // 0x02C0(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              SyncedTimestamp;                                          // 0x02C8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DestinyValue;                                             // 0x02CC(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              WarmScore;                                                // 0x02D0(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              AIAllocMarkValue;                                         // 0x02D4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                LeaderCount;                                              // 0x02D8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x4];                                       // 0x02DC(0x0004) MISSED OFFSET
	uint64_t                                           LastGameLeaderUID;                                        // 0x02E0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<uint64_t>                                   LastGameTeammatesUID;                                     // 0x02E8(0x0010) (ZeroConstructor)
	uint64_t                                           LastGameBattleID;                                         // 0x02F8(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              RatingScore;                                              // 0x0300(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bDoPlayerUseAutoFollow;                                   // 0x0304(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0305(0x0003) MISSED OFFSET
	float                                              MaxRankingScore;                                          // 0x0308(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           ObserverFlags;                                            // 0x030C(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           WatchPlayerKey;                                           // 0x0310(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bIsHawkEyeSpectator;                                      // 0x0318(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0319(0x0003) MISSED OFFSET
	int                                                HawkEyeSpectateMaxMatchCount;                             // 0x031C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                HawkEyeSpectateUsedMatchCount;                            // 0x0320(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      PlatformGender;                                           // 0x0324(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x3];                                       // 0x0325(0x0003) MISSED OFFSET
	int                                                planeAvatarId;                                            // 0x0328(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                DyeDebugFlag;                                             // 0x032C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     Nation;                                                   // 0x0330(0x0010) (ZeroConstructor)
	int                                                MatchLabel;                                               // 0x0340(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               OnlyTeammateSeeAvatar;                                    // 0x0344(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData13[0x3];                                       // 0x0345(0x0003) MISSED OFFSET
	int64_t                                            LastGameResultTime;                                       // 0x0348(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CorpsID;                                                  // 0x0350(0x0008) (ZeroConstructor, IsPlainOldData)
	int64_t                                            CampID;                                                   // 0x0358(0x0008) (ZeroConstructor, IsPlainOldData)
	bool                                               bUsedSimulation;                                          // 0x0360(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bRoomCanKickPlayer;                                       // 0x0361(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCanDownloadInBattle;                                     // 0x0362(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x5];                                       // 0x0363(0x0005) MISSED OFFSET
	struct FString                                     IpCountryStr;                                             // 0x0368(0x0010) (ZeroConstructor)
	bool                                               bRoomOwner;                                               // 0x0378(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData15[0x3];                                       // 0x0379(0x0003) MISSED OFFSET
	int                                                VeteranRecruitIndex;                                      // 0x037C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MatchStrategyLabel;                                       // 0x0380(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData16[0x4];                                       // 0x0384(0x0004) MISSED OFFSET
	TArray<struct FDailyTaskStoreInfo>                 DailyTaskStoreList;                                       // 0x0388(0x0010) (ZeroConstructor)
	int                                                LandId;                                                   // 0x0398(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FollowType;                                               // 0x039C(0x0004) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           FollowUID;                                                // 0x03A0(0x0008) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           TaskSyncToDsTs;                                           // 0x03A8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x4];                                       // 0x03AC(0x0004) MISSED OFFSET
	uint64_t                                           LuckmateUID;                                              // 0x03B0(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     GameAPPIDFromDS;                                          // 0x03B8(0x0010) (ZeroConstructor)
	float                                              RealHiddenScore;                                          // 0x03C8(0x0004) (ZeroConstructor, IsPlainOldData)
...
{
	int8_t                                             AIType;                                                   // 0x03CC(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x03CD(0x0003) MISSED OFFSET
	uint32_t                                           AILevel;                                                  // 0x03D0(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLAIPlayer;                                              // 0x03D4(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bMLDelivery;                                              // 0x03D5(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x03D6(0x0002) MISSED OFFSET
	uint32_t                                           MLBotType;                                                // 0x03D8(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bBornIslandAI;                                            // 0x03DC(0x0001) (ZeroConstructor, IsPlainOldData)
