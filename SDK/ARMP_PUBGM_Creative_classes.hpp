...
public:
	...
	float                                              DebugAngle;                                               // 0x0B48(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bIgnoreLandOn;                                            // 0x122A(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreWaterHeightCheck;                                  // 0x122B(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreCameraRotate;                                      // 0x122C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x122D(0x0003) MISSED OFFSET
	struct FRotator                                    ModifiedRotation;                                         // 0x1230(0x000C) (IsPlainOldData)
	struct FVector                                     ModifiedScale;                                            // 0x123C(0x000C) (IsPlainOldData)
	struct FRotator                                    RelativeRotation;                                         // 0x1248(0x000C) (IsPlainOldData)
	struct FVector                                     RelativeLocation;                                         // 0x1254(0x000C) (IsPlainOldData)
	struct FVector                                     RelativeScale;                                            // 0x1260(0x000C) (IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x126C(0x0004) MISSED OFFSET
	struct FTransform                                  SnapBaseTransform;                                        // 0x1270(0x0030) (IsPlainOldData)
	struct FVector                                     DeviceLocationOffset;                                     // 0x12A0(0x000C) (IsPlainOldData)
	struct FVector                                     InstanceBoxCenter;                                        // 0x12AC(0x000C) (IsPlainOldData)
	struct FVector                                     InstanceBoxExtent;                                        // 0x12B8(0x000C) (IsPlainOldData)
	bool                                               bOpenLandPosCheckDebug;                                   // 0x12C4(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0xB];                                       // 0x12C5(0x000B) MISSED OFFSET
...
public:
	...
	struct FLuaNetSerialization                        LuaNetSerialization;                                      // 0x0510(0x0050) (Net)
	bool                                               IsTopView;                                                // 0x0560(0x0001) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0561(0x0003) MISSED OFFSET
	int                                                TopViewRotateAngle;                                       // 0x0564(0x0004) (Net, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bIsFollowing;                                             // 0x0588(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0589(0x0003) MISSED OFFSET
	int                                                FollowType;                                               // 0x058C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsLerping;                                               // 0x0590(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0591(0x0003) MISSED OFFSET
	float                                              LerpTime;                                                 // 0x0594(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BlendExp;                                                 // 0x0598(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BlendTimeToGo;                                            // 0x059C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              blendTime;                                                // 0x05A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     SocketOffset;                                             // 0x05A4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    RotatorOffset;                                            // 0x05B0(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	TWeakObjectPtr<class AActor>                       FollowTarget;                                             // 0x05BC(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EViewTargetBlendFunction>              BlendFunction;                                            // 0x05C4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x05C5(0x0003) MISSED OFFSET
	struct FRotator                                    ActorStartRot;                                            // 0x05C8(0x000C) (BlueprintVisible, IsPlainOldData)
	struct FRotator                                    ActorTargetRot;                                           // 0x05D4(0x000C) (BlueprintVisible, IsPlainOldData)
	struct FVector                                     targetPos;                                                // 0x05E0(0x000C) (BlueprintVisible, IsPlainOldData)
	struct FRotator                                    TargetRot;                                                // 0x05EC(0x000C) (BlueprintVisible, IsPlainOldData)
	struct FVector                                     StartPos;                                                 // 0x05F8(0x000C) (BlueprintVisible, IsPlainOldData)
	struct FRotator                                    StartRot;                                                 // 0x0604(0x000C) (BlueprintVisible, IsPlainOldData)
	float                                              StartFOV;                                                 // 0x0610(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              StartArmLength;                                           // 0x0614(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FRotator                                    EndRot;                                                   // 0x0618(0x000C) (BlueprintVisible, IsPlainOldData)
	float                                              EndFOV;                                                   // 0x0624(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              EndArmLength;                                             // 0x0628(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x062C(0x0004) MISSED OFFSET
	struct FName                                       SocketName;                                               // 0x0630(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxPilotDist;                                             // 0x0638(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bPilotPosition;                                           // 0x063C(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	ECreativeModeActorState                            ActorState;                                               // 0x0580(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0581(0x0007) MISSED OFFSET
	TMap<class UObject*, struct FCreativePoolObjectRecordInfo> PoolObjectRecordMap;                                      // 0x0588(0x0050) (ZeroConstructor)
	int8_t                                             CanEditFlag;                                              // 0x05D8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreCollisionCheck;                                    // 0x05D9(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x05DA(0x0006) MISSED OFFSET
	TArray<class AActor*>                              IgnoreActors;                                             // 0x05E0(0x0010) (ZeroConstructor)
	struct FEditorObjectLiteComponentTickFunction      LiteComponentActorTick;                                   // 0x05F0(0x0058) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x0648(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0658(0x0008) MISSED OFFSET
...
// 0x0130 (0x2380 - 0x2250)
class ACreativeModeGameMode : public ABattleRoyaleGameModeTeam
{
public:
	class UCreativeModeGameModeBaseComponent*          CurrentModeComponent;                                     // 0x2250(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	TArray<class UClass*>                              GameModeComponentClassArray;                              // 0x2258(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      GameModeComponentClass;                                   // 0x2268(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TMap<struct FString, struct FGameModeParam>        MapPlaneRouteConfigs;                                     // 0x2270(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
	TMap<struct FString, struct FString>               MapVehicleClassPathConfigs;                               // 0x22C0(0x0050) (Edit, ZeroConstructor, DisableEditOnInstance)
	ECreativeModeGameType                              EditorStartupGameType;                                    // 0x2310(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x2311(0x0001) MISSED OFFSET
	bool                                               bIsCreativeWoW;                                           // 0x2312(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x5];                                       // 0x2313(0x0005) MISSED OFFSET
	struct FGameModeLiteComponentTickFunction          LiteComponentActorTick;                                   // 0x2318(0x0058) (Edit, DisableEditOnInstance)
	TArray<class ULiteComponent*>                      LiteComponents;                                           // 0x2370(0x0010) (ZeroConstructor, Transient)
...
public:
	...
	unsigned char                                      UnknownData06[0xF0];                                      // 0x0460(0x00F0) MISSED OFFSET
...
public:
	...
	TArray<class USTExtraManagerBase*>                 ManagerArray;                                             // 0x0440(0x0010) (ZeroConstructor, Transient)
	TArray<class UClass*>                              ManagerClassArray;                                        // 0x0450(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
...
public:
	...
	TMap<struct FString, struct FCreativeInstanceNode> CppInstanceTree;                                          // 0x0380(0x0050) (ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x0B20(0x0020) MISSED OFFSET
	struct FSoftObjectPath                             SoftStaticMeshPath;                                       // 0x0B40(0x0018)
	class UMaterialInterface*                          WaitSetMaterial;                                          // 0x0B58(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FTransform>                          WaitSetAddInstanceTransforms;                             // 0x0B60(0x0010) (ZeroConstructor)
...
public:
	...
	struct FCreativeBatchInstancedStaticMesh           InstancedStaticMeshInfo;                                  // 0x0530(0x0058)
...
public:
	...
	struct FVector                                     AxisState;                                                // 0x0508(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     ForceHideAxis;                                            // 0x0514(0x000C) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData01[0x48];                                      // 0x0520(0x0048) MISSED OFFSET
	class APlayerCameraManager*                        PlayerCameraManager;                                      // 0x0568(0x0008) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	TMap<struct FString, class UCreativePhysicsComponent*> InstancePhysicsComponentMap;                              // 0x0500(0x0050) (ExportObject, ZeroConstructor)
	unsigned char                                      UnknownData01[0x6C];                                      // 0x0550(0x006C) MISSED OFFSET
	int                                                TickRegisterMaxNum;                                       // 0x05BC(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate                             MeshLoadSuccessDelegate;                                  // 0x05C0(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             MeshLoadSuccessByPathDelegate;                            // 0x05D0(0x0010) (ZeroConstructor, InstancedReference)
	TMap<struct FString, struct FPhysicsComponentData> ComponentTempData;                                        // 0x05E0(0x0050) (ZeroConstructor)
	int                                                ReplicateLimit;                                           // 0x0630(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UBodySetup*                                  BodySetup;                                                // 0x0858(0x0008) (ZeroConstructor, IsPlainOldData)
	class UStaticMesh*                                 InStaticMesh;                                             // 0x0860(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FString                                     InstanceID;                                               // 0x0868(0x0010) (ZeroConstructor)
	struct FName                                       CollisionProfileName;                                     // 0x0878(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x30];                                      // 0x0880(0x0030) MISSED OFFSET
	struct FScriptDelegate                             MatLoadSuccessDelegate;                                   // 0x08B0(0x0010) (ZeroConstructor, InstancedReference)
...
// 0x02F8 (0x07E8 - 0x04F0)
class ACreativeRuntimePlayerBattleDataObject : public ALuaActor
{
public:
	struct FRuntimePlayerBattleDataInfo                DefaultPlayerBattleDataInfo;                              // 0x04F0(0x0060)
	struct FRuntimeTeamGameOutcomeConditionInfo        DefaultTeamGameOutcomeCondition;                          // 0x0550(0x001C)
	unsigned char                                      UnknownData00[0x4];                                       // 0x056C(0x0004) MISSED OFFSET
	struct FRuntimeCacheRoundBattleDataInfoContainer   RuntimeOldCacheRoundBattleDataContainer;                  // 0x0570(0x00C8) (Net, Transient)
	struct FRuntimeBattleDataInfoContainer             RuntimeCurRoundBattleDataInfoContainer;                   // 0x0638(0x00C8) (Net, Transient)
	struct FRuntimeTeamGameOutcomeConditionContainer   RuntimeTeamGameOutcomeConditionContainer;                 // 0x0700(0x00C8) (Net, Transient)
	struct FRuntimeCacheRoundBattleDataInfo            DefaultCacheRoundBattleDataInfo;                          // 0x07C8(0x0020)
...
{
public:
	struct FScriptMulticastDelegate                    OnPostAsyncLoadFinishEvent;                               // 0x09D0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      bOnlyRender : 1;                                          // 0x09E0(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x7];                                       // 0x09E1(0x0007) MISSED OFFSET
	unsigned char                                      UnknownData01[0x28];                                      // 0x09E1(0x0028) UNKNOWN PROPERTY: SoftObjectProperty Creative.SoftStaticMeshComponent.SoftStaticMesh
	struct FSoftObjectPath                             SoftStaticMeshPath;                                       // 0x0A10(0x0018)
	unsigned char                                      bAsyncLoad : 1;                                           // 0x0A28(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
...
{
public:
	class APawn*                                       SyncPlayerCharacter;                                      // 0x04F0(0x0008) (Net, ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                MapMarkID;                                                // 0x04F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bEnableRefresh;                                           // 0x04F4(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x04F5(0x0003) MISSED OFFSET
	int                                                BatchNum;                                                 // 0x04F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                CurBatchID;                                               // 0x04FC(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	int                                                CurBatchNum;                                              // 0x0500(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x24];                                      // 0x0504(0x0024) MISSED OFFSET
	TArray<struct FVector_NetQuantize>                 TeamPosData;                                              // 0x0528(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData02[0x50];                                      // 0x0538(0x0050) UNKNOWN PROPERTY: SetProperty Creative.ShowAllPlayerManagerActor.TriggerPlayerKeySet
	TArray<struct FMarkDispatchAction>                 MapMarkActionList;                                        // 0x0588(0x0010) (ZeroConstructor)
