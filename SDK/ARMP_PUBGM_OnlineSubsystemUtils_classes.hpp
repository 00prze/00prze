...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x0438(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x043C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x0440(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x0458(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x0460(0x0008) (ZeroConstructor, IsPlainOldData)
	EBeaconConnectionState                             ConnectionState;                                          // 0x0468(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2F];                                      // 0x0469(0x002F) MISSED OFFSET
...
{
public:
	int                                                ListenPort;                                               // 0x0458(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x0430(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0440(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0448(0x0010) (ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0x30];                                      // 0x0498(0x0030) MISSED OFFSET
	struct FString                                     DestSessionId;                                            // 0x04C8(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x04D8(0x0030)
	EClientRequestType                                 RequestType;                                              // 0x0508(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0509(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x050A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2D];                                      // 0x050B(0x002D) MISSED OFFSET
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x0458(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x50];                                      // 0x0460(0x0050) MISSED OFFSET
	bool                                               bLogoutOnSessionTimeout;                                  // 0x04B0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x04B1(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x04B4(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x04B8(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
