...
struct FAIStateInfoBaseMod : public FUniqueStateInfo
{
	...
	TArray<uint64_t>                                   nearby_item_index;                                        // 0x0248(0x0010) (ZeroConstructor)
	TArray<struct FObstacleState>                      nearby_obstacle;                                          // 0x0258(0x0010) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_obstacle_index;                                    // 0x0268(0x0010) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x0278(0x0010) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x0288(0x0010) (ZeroConstructor)
	struct FAIPlayerHitInfo                            player_hit_info;                                          // 0x0298(0x0028)
	uint32_t                                           Key;                                                      // 0x02C0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x02C4(0x0004) MISSED OFFSET
	struct FAIBulletHoles                              bullet_holes;                                             // 0x02C8(0x0030)
	uint32_t                                           ai_style;                                                 // 0x02F8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x02FC(0x0004) MISSED OFFSET
	struct FAIStateConfig                              Config;                                                   // 0x0300(0x0018)
	struct FDamageRateInfo                             damage_rate_info;                                         // 0x0318(0x0038)
	struct FChatMsgInfo                                chatmsg_info;                                             // 0x0350(0x0030)
	struct FSignMsgInfo                                signmsg_info;                                             // 0x0380(0x0028)
	struct FMapMarkInfo                                mapmark_info;                                             // 0x03A8(0x0030)
	TArray<struct FAIAvatarInfo>                       avatar_info;                                              // 0x03D8(0x0010) (ZeroConstructor)
	TArray<struct FAIDestroyBulletProbInfo>            destroy_bullet_prob_info;                                 // 0x03E8(0x0010) (ZeroConstructor)
};
...
struct FAIStateInfoBRBase : public FUniqueStateInfo
{
	...
	uint32_t                                           deliver_target_id;                                        // 0x0088(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FVehicleState                               vehicle_state;                                            // 0x0090(0x00C8)
	TArray<struct FVehicleState>                       nearby_vehicles;                                          // 0x0158(0x0010) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_vehicles_index;                                    // 0x0168(0x0010) (ZeroConstructor)
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0178(0x0010) (ZeroConstructor)
	TArray<struct FDynamicItem>                        dynamic_items;                                            // 0x0188(0x0010) (ZeroConstructor)
	TArray<uint64_t>                                   dynamic_items_index;                                      // 0x0198(0x0010) (ZeroConstructor)
	TArray<struct FMonsterState>                       monster_states;                                           // 0x01A8(0x0010) (ZeroConstructor)
	TArray<uint64_t>                                   monster_states_index;                                     // 0x01B8(0x0010) (ZeroConstructor)
};
...
{
	struct FAIPlayerStateBRBase                        State;                                                    // 0x0018(0x0050)
	struct FDiffDoorStateGeneral                       nearby_door;                                              // 0x0068(0x0030)
	TArray<uint64_t>                                   nearby_door_index;                                        // 0x0098(0x0010) (ZeroConstructor)
	struct FVehicleState                               vehicle_state;                                            // 0x00A8(0x00C8)
	struct FDiffVehicleStatesGeneral                   nearby_vehicles;                                          // 0x0170(0x0030)
	TArray<uint64_t>                                   nearby_vehicles_index;                                    // 0x01A0(0x0010) (ZeroConstructor)
	uint32_t                                           deliver_target_id;                                        // 0x01B0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x01B4(0x0004) MISSED OFFSET
	TArray<struct FAIRecipients>                       recipients;                                               // 0x01B8(0x0010) (ZeroConstructor)
	struct FDiffDynamicItemStatesGeneral               dynamic_items;                                            // 0x01C8(0x0030)
	TArray<uint64_t>                                   dynamic_items_index;                                      // 0x01F8(0x0010) (ZeroConstructor)
	struct FDiffMonsterStatesGeneral                   monster_states;                                           // 0x0208(0x0030)
	TArray<uint64_t>                                   monster_states_index;                                     // 0x0238(0x0010) (ZeroConstructor)
};
...
struct FAIBRBaseStateInfo : public FUniqueStateInfo
{
	...
	TArray<struct FAIRecipients>                       recipients;                                               // 0x0068(0x0010) (ZeroConstructor)
};
...
struct FDiffAIPlayerBRBaseState : public FAIStateInfoBase
{
	...
	struct FDiffStateInfoBool                          is_be_spectated;                                          // 0x0018(0x0001)
...
struct FMLAINearbyStateInfoBaseMod : public FUniqueStateInfo
{
	...
	TArray<struct FObstacleState>                      nearby_obstacle;                                          // 0x0038(0x0010) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_obstacle_index;                                    // 0x0048(0x0010) (ZeroConstructor)
	TArray<struct FAINearbyThrown>                     nearby_thrown;                                            // 0x0058(0x0010) (ZeroConstructor)
	TArray<uint64_t>                                   nearby_thrown_index;                                      // 0x0068(0x0010) (ZeroConstructor)
};
