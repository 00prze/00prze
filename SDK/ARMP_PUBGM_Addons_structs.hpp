...
struct FSkillAction_SpawnActorCreateData
{
	...
	bool                                               bUseOffsetWithOutLocationPicker;                          // 0x006C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseOffsetWithDamagePicker;                               // 0x006D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableAttach;                                            // 0x006E(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x1];                                       // 0x006F(0x0001) MISSED OFFSET
	struct FName                                       AttachSocket;                                             // 0x0070(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlignMainMesh;                                           // 0x0078(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlignRotation;                                           // 0x0079(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAlignScale3D;                                            // 0x007A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x007B(0x0001) MISSED OFFSET
	struct FVector                                     OffsetLocationStand;                                      // 0x007C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     OffsetLocationCrouch;                                     // 0x0088(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     OffsetLocationProne;                                      // 0x0094(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    OffsetRotation;                                           // 0x00A0(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bAllowChangePoseWillUpdating;                             // 0x00AC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x00AD(0x0003) MISSED OFFSET
	struct FUAEBlackboardKeySelector                   CachedSpawnActorKey;                                      // 0x00B0(0x0008) (Edit, BlueprintVisible)
};
...
struct FAnimNode_HumanoidLeggedIK : public FAnimNode_SkeletalControlBase
{
	...
	TArray<TEnumAsByte<ECollisionChannel>>             ObjectTypesToTrace;                                       // 0x0158(0x0010) (Edit, ZeroConstructor)
	float                                              FootTraceUpOffset;                                        // 0x0168(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootTraceDownOffset;                                      // 0x016C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootTraceSphereRadius;                                    // 0x0170(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RootPositionLerpSpeed;                                    // 0x0174(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootPositionLerpSpeed;                                    // 0x0178(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootRotationLerpSpeed;                                    // 0x017C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RootHeightOffsetScale;                                    // 0x0180(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RootMaxHeightOffset;                                      // 0x0184(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxHeightOffset;                                      // 0x0188(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxPitchOffset;                                       // 0x018C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FootMaxRollOffset;                                        // 0x0190(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x90];                                      // 0x0520(0x0090) MISSED OFFSET
};
